...
//Code Here
let myStrongest = monstersInYourPocket.filter((el, i) => monstersInYourPocket[i].CP > 200)
...
// let findBob = purchases.filter(el => el.owner === "Bob")

// let bobsTotal = findBob.reduce((acc, el, i, arr) => acc += el.price, 0)
